...
6. Dissasociate the API gateway from the WAF by going to the section AWS resources using this web ACL in the Rules tab and clicking the x at the right of the API gateway stage
![](../img/resource-cleanup/2026-01-30-08-54-41.png)
7. On the Web ACLs page, confirm that the web ACL that you want to delete is selected, and then choose Delete.
